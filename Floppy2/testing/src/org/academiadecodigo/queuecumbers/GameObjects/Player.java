...
import org.academiadecodigo.simplegraphics.pictures.Picture;
    ...
    public class Player implements KeyboardHandler {
        ...
        public void keyboard() {
            ...
            inputJump.setKey(KeyboardEvent.KEY_SPACE);
            inputJump.setKeyboardEventType(KeyboardEventType.KEY_RELEASED);
        ...
        public void explosion() {
            cucumber.delete();
            explosion = new Picture (fieldPosition.getCol()-80, fieldPosition.getRow()-50, "pictures\\boom.PNG");
            explosion.draw();
        }
